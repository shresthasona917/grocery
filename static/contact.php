                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Simal Tandi, Khairahani Municipality , Chitwan, Nepal</span> 
										<span class="text-secondary">Simal Tandi, Khairahani Municipality , Chitwan, Nepal</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-secondary">+977 9801889892</span>
										<span class="text-secondary">+977 9801889891 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">findmepropertyhelp@yopmail.com</span>
										<span class="text-secondary">findmeproperty@yopmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
